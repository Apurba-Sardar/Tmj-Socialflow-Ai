...
ADD COLUMN IF NOT EXISTS "contentCategory" TEXT NOT NULL DEFAULT 'ARTICLE';

DROP INDEX IF EXISTS "PromptTemplate_organizationId_platform_purpose_active_key";
DROP INDEX IF EXISTS "PromptTemplate_organizationId_platform_purpose_contentCategory_active_key";
...
DROP INDEX IF EXISTS "PromptTemplate_platform_purpose_idx";
DROP INDEX IF EXISTS "PromptTemplate_platform_purpose_contentCategory_idx";
