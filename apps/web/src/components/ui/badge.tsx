...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-2.5 py-1 text-[0.7rem] font-semibold transition-colors',
  {
    variants: {
      variant: {
        default:
        ...
        destructive: 'border-rose-500/20 bg-rose-500/12 text-rose-700 dark:text-rose-300',
      },
    },
    defaultVariants: {
      variant: 'default',
